...
alias nautilus="nemo"
alias s="screen"
alias sp="screen plowdown"
alias wget='wget -c'
alias localinstall='sudo yum localinstall --nogpgcheck'
alias htpcnox='ssh htpc'
alias oct="stat -c '%a %n'"
export PATH=$PATH:/home/kzz5/bin:/home/kzz5/AndroidSDK/platform-tools:/sbin
